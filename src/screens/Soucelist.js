...
export default function Soucelist() {
    ...
    //eslint-disable-next-line
      useEffect(async () => {
        const response = await axios.get('https://pizzadeliveryback.herokuapp.com/Souce/getsouce');
        setSouceList(response.data);
    },[])

    const deleteSouce = async(id) =>{
        var response = await axios.delete(`https://pizzadeliveryback.herokuapp.com/Souce/deletesouce/${id}`, {souces})
