      ...
      <AppBar position="static" > 
        <Toolbar>
          <Typography component="div" sx={{ flexGrow: 1 }} href="/Home">
           <Button  style={{fontSize:"25px"}}><Link to="/Home" style={{textDecoration:"none",color:"black"}}>Streetza Pizzas</Link></Button>
          </Typography>
          ...
          <IconButton
            ...
            <Link to="/login"  style={{textDecoration:"none",color:"black"}}>Login</Link></Button>)}
          <Button
